// include/ipc/shm_protocol.h - UNIFIED VERSION (Metadata + Video Buffer)
#pragma once

#ifdef _WIN32
#include <windows.h>   // For MemoryBarrier, InterlockedIncrement
#include <intrin.h>    // For _WriteBarrier, _ReadBarrier
#endif
...
constexpr uint32_t SHM_MAGIC = 0x46414345;  // "FACE"
constexpr uint32_t SHM_VERSION = 4;          // Version 4: Unified
...
struct ObjectDetection {
    ...
    char class_name[64];       // Increased from 32
};
