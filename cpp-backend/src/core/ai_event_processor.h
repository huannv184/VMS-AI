...
// PpeComplianceAggregator was inlined in this header until PR-7B (2026-05-25)
// extracted it into its own TU so integration tests can link the class
// without dragging in AiEventProcessor's dependency graph. Include preserved
// here so existing #include "core/ai_event_processor.h" sites still resolve
// PpeComplianceAggregator without changes.
